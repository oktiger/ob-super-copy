...
const zh: Translation = {
	codeBlockPlain: "普通代码框（不指定语言）", copyFolder: "复制文件夹", copyFile: "复制文件", copyCurrentFile: "复制当前文件", insertMarkdownCodeBlock: "插入 Markdown 代码框", copyContent: "复制内容",
...
const zhTW: Translation = {
	codeBlockPlain: "一般程式碼區塊（不指定語言）", copyFolder: "複製資料夾", copyFile: "複製檔案", copyCurrentFile: "複製目前檔案", insertMarkdownCodeBlock: "插入 Markdown 程式碼區塊", copyContent: "複製內容",
...
const ja: Translation = {
	codeBlockPlain: "プレーンコードブロック（言語指定なし）", copyFolder: "フォルダーをコピー", copyFile: "ファイルをコピー", copyCurrentFile: "現在のファイルをコピー", insertMarkdownCodeBlock: "Markdown コードブロックを挿入", copyContent: "内容をコピー",
...
const ko: Translation = {
	codeBlockPlain: "일반 코드 블록(언어 지정 없음)", copyFolder: "폴더 복사", copyFile: "파일 복사", copyCurrentFile: "현재 파일 복사", insertMarkdownCodeBlock: "Markdown 코드 블록 삽입", copyContent: "내용 복사",
...
const de: Translation = {
	codeBlockPlain: "Einfacher Codeblock (keine Sprache)", copyFolder: "Ordner kopieren", copyFile: "Datei kopieren", copyCurrentFile: "Aktuelle Datei kopieren", insertMarkdownCodeBlock: "Markdown-Codeblock einfügen", copyContent: "Inhalt kopieren",
...
const fr: Translation = {
	codeBlockPlain: "Bloc de code simple (sans langage)", copyFolder: "Copier le dossier", copyFile: "Copier le fichier", copyCurrentFile: "Copier le fichier actuel", insertMarkdownCodeBlock: "Insérer un bloc de code Markdown", copyContent: "Copier le contenu",
...
const es: Translation = {
	codeBlockPlain: "Bloque de código simple (sin lenguaje)", copyFolder: "Copiar carpeta", copyFile: "Copiar archivo", copyCurrentFile: "Copiar archivo actual", insertMarkdownCodeBlock: "Insertar bloque de código Markdown", copyContent: "Copiar contenido",
...
const ptBR: Translation = {
	codeBlockPlain: "Bloco de código simples (sem linguagem)", copyFolder: "Copiar pasta", copyFile: "Copiar arquivo", copyCurrentFile: "Copiar arquivo atual", insertMarkdownCodeBlock: "Inserir bloco de código Markdown", copyContent: "Copiar conteúdo",
