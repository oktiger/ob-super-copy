...
const zh: Translation = {
	...
	codeBlockPlain: "普通代码框（不指定语言）", copyFolder: "复制文件夹", copyFile: "复制文件", copyCurrentFile: "复制当前文件", newFile: "新建", newFolder: "新建文件夹", fileCreated: (path) => `已新建文件：${path}`, fileCreateFailed: "新建文件失败", folderCreated: (path) => `已新建文件夹：${path}`, folderCreateFailed: "新建文件夹失败", insertMarkdownCodeBlock: "插入 Markdown 代码框", copyContent: "复制内容",
...
const zhTW: Translation = {
	...
	codeBlockPlain: "一般程式碼區塊（不指定語言）", copyFolder: "複製資料夾", copyFile: "複製檔案", copyCurrentFile: "複製目前檔案", newFile: "新增", newFolder: "新增資料夾", fileCreated: (path) => `已新增檔案：${path}`, fileCreateFailed: "新增檔案失敗", folderCreated: (path) => `已新增資料夾：${path}`, folderCreateFailed: "新增資料夾失敗", insertMarkdownCodeBlock: "插入 Markdown 程式碼區塊", copyContent: "複製內容",
...
const ja: Translation = {
	...
	codeBlockPlain: "プレーンコードブロック（言語指定なし）", copyFolder: "フォルダーをコピー", copyFile: "ファイルをコピー", copyCurrentFile: "現在のファイルをコピー", newFile: "新規作成", newFolder: "新規フォルダー", fileCreated: (path) => `ファイルを作成しました：${path}`, fileCreateFailed: "ファイルを作成できませんでした", folderCreated: (path) => `フォルダーを作成しました：${path}`, folderCreateFailed: "フォルダーを作成できませんでした", insertMarkdownCodeBlock: "Markdown コードブロックを挿入", copyContent: "内容をコピー",
...
const ko: Translation = {
	...
	codeBlockPlain: "일반 코드 블록(언어 지정 없음)", copyFolder: "폴더 복사", copyFile: "파일 복사", copyCurrentFile: "현재 파일 복사", newFile: "새로 만들기", newFolder: "새 폴더", fileCreated: (path) => `파일을 만들었습니다: ${path}`, fileCreateFailed: "파일을 만들지 못했습니다", folderCreated: (path) => `폴더를 만들었습니다: ${path}`, folderCreateFailed: "폴더를 만들지 못했습니다", insertMarkdownCodeBlock: "Markdown 코드 블록 삽입", copyContent: "내용 복사",
...
const de: Translation = {
	...
	codeBlockPlain: "Einfacher Codeblock (keine Sprache)", copyFolder: "Ordner kopieren", copyFile: "Datei kopieren", copyCurrentFile: "Aktuelle Datei kopieren", newFile: "Neu erstellen", newFolder: "Neuer Ordner", fileCreated: (path) => `Datei erstellt: ${path}`, fileCreateFailed: "Datei konnte nicht erstellt werden", folderCreated: (path) => `Ordner erstellt: ${path}`, folderCreateFailed: "Ordner konnte nicht erstellt werden", insertMarkdownCodeBlock: "Markdown-Codeblock einfügen", copyContent: "Inhalt kopieren",
...
const es: Translation = {
	...
	codeBlockPlain: "Bloque de código simple (sin lenguaje)", copyFolder: "Copiar carpeta", copyFile: "Copiar archivo", copyCurrentFile: "Copiar archivo actual", newFile: "Añadir", newFolder: "Nueva carpeta", fileCreated: (path) => `Archivo creado: ${path}`, fileCreateFailed: "No se pudo crear el archivo", folderCreated: (path) => `Carpeta creada: ${path}`, folderCreateFailed: "No se pudo crear la carpeta", insertMarkdownCodeBlock: "Insertar bloque de código Markdown", copyContent: "Copiar contenido",
...
const ptBR: Translation = {
	...
	codeBlockPlain: "Bloco de código simples (sem linguagem)", copyFolder: "Copiar pasta", copyFile: "Copiar arquivo", copyCurrentFile: "Copiar arquivo atual", newFile: "Adicionar", newFolder: "Nova pasta", fileCreated: (path) => `Arquivo criado: ${path}`, fileCreateFailed: "Não foi possível criar o arquivo", folderCreated: (path) => `Pasta criada: ${path}`, folderCreateFailed: "Não foi possível criar a pasta", insertMarkdownCodeBlock: "Inserir bloco de código Markdown", copyContent: "Copiar conteúdo",
